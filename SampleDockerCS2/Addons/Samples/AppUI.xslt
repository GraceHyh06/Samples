...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="ef87c4b0-cf63-416f-9a5c-6a107515beee" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('178e7135-4c8f-4e69-8d05-cb807b0f1fae')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="测试插件"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="93967add-4062-4ccd-807f-f05ed04746c6"
                type="wpfhost"
                hostedType="Addons\\.dll,SampleDockerCS2.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="178e7135-4c8f-4e69-8d05-cb807b0f1fae"
                  userCaption="测试插件"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="93967add-4062-4ccd-807f-f05ed04746c6"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
