...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="528e117f-36d0-4c94-9914-8c36a6df9a04" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('4b2db668-6ce6-49ae-bdc1-9adf09ca2768')"
      ...
      <itemData guid="becdcf61-465b-419e-9f17-c5d977c79ed9"
                type="wpfhost"
                hostedType="Addons\\.dll,SampleDockerCS1.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="4b2db668-6ce6-49ae-bdc1-9adf09ca2768"
                  userCaption="Enter Caption"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="becdcf61-465b-419e-9f17-c5d977c79ed9"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
